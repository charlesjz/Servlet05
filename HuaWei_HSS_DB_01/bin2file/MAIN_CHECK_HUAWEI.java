...
public class MAIN_CHECK_HUAWEI extends JFrame{
    ...
    String sql,file_name,dir="E:/SQL/华为HLR数据库原始文件/",hlr_name="HLR";


	public MAIN_CHECK_HUAWEI(String title) {
...
//				来电显示
	...
	public static void main(String[] args) throws Exception {
        new MAIN_CHECK_HUAWEI("HuaWei HLR Report - www.HLRDB.com");
