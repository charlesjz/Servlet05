...
public class CustomerActivityLogger implements ApplicationListener {
	...
	public void onApplicationEvent ( ApplicationEvent event ) {
		...
		if ( event instanceof NewAccountEvent )
		{
			...
			System.out.println ( "Customer Activity Logger: " + new Date( event.getTimestamp() ) + " : Account (" + newAccountEvent.getAccount() + ") has been created for customer " + newAccountEvent.getCustomer() );
		}
		else if ( event instanceof NewCustomerCreatedEvent )
		{
			...
			System.out.println ( "Customer Activity Logger: " + new Date( event.getTimestamp() ) + " : A new customer created (" + newCustomerCreatedEvent.getCustomer() + ")" );
		}
	}
