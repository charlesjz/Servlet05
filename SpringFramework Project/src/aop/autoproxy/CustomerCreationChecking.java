...
public class CustomerCreationChecking implements MethodInterceptor {
	...
	public Object invoke(MethodInvocation invocation) throws Throwable {
		...
		System.out.println ( "Advice: " + this.getClass().getName() + ", methodName = " + invocation.getMethod().getName() );
...
//		{
			...
			{
				System.err.println ( "This customer no (" + customer.getCustomerNo() + ") has been used." );
