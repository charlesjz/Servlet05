...
public class Sample3a1 {
	...
	public static void main(String[] args) {
		...
		try
		{
			ApplicationContext beanFactory = new FileSystemXmlApplicationContext ( "src/aop/pointcut/sample.xml" );
			...
			Customer customer3 = new Customer ( 2, "Paul", "Martin", "(416)123-1232", "12 Sheppard Ave E", "paul.martin@gov.ca" );
