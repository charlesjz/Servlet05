...
public class CustomerServiceImpl implements CustomerService, ApplicationContextAware {
	...
	public List getAccountList(Customer customer) {
		// Actually, we can use Hibernate's feature of association
		// to get action list from the customer object, that is:
	...
	public void createAccount(Customer customer, Account account) {
		...
		// We can use either one of the following lines to insert the account
		// because the account has a m-1 association to customer.
