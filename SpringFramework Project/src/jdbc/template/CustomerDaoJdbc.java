...
//								   new Object[] { new Integer ( customer.getCustomerNo() ),
		...
		customer.setCustomerNo(generatedCustomerNo);
	}
	...
	public List getAccountList(final Customer customer) {
		...
		return (List) this.jdbcTemplate.query ( this.crudStatements.getAccountListSql(),
										  params,
