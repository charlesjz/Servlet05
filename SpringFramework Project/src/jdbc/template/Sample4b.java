...
public class Sample4b {
	...
	public static void main(String[] args) {
		...
		try
		{
			ApplicationContext beanFactory = new FileSystemXmlApplicationContext ( "/src/jdbc/template/sample.xml" );
...
//			AccountService accountService = (AccountService) beanFactory.getBean ( "accountService" );
			...
			Customer customer11 = customerService.getCustomer ( 21 );
			Customer customer22 = customerService.getCustomer ( 22 );
