 ...
 * demostrates the RMI usage.
 * 
 */
public class Sample5bClient {

	/**
	 * 
	 */
	public Sample5bClient() {
		super();
	...
	public static void main(String[] args) {
		...
		try
		{
			ApplicationContext beanFactory = new FileSystemXmlApplicationContext ( "src/remote/http/client/sample.xml" );
			...
			customerService.sendMessage( "Hello, this is my request." );
			String message = customerService.receiveMessage();
			System.out.println ( "I've received the message: " + message );
