 ...
 * sample5a.client package for client side implementation.
 * 
 */
public class Sample5a {
	...
	public static void main(String[] args) {
		...
		try
		{
			ApplicationContext beanFactory = new FileSystemXmlApplicationContext ( "src/remote/rmi/sample.xml" );
	...
	public static void main2(String[] args) {
		...
		try
		{
			ApplicationContext beanFactory = new FileSystemXmlApplicationContext ( "sample5a/sample.xml" );
			System.out.println ( "The BeanFactory instance obtained." );
