 ...
 * @author David Gao
 *
 * This sample adds programming transaction control for JDBC operations (based on
 * sample4b).
 * 
 * The transaction control has been added to the following methods:
 * 1) CustomerDaoJdbc.create ( List customers ); it throws InvalidCustomerNameException.
 * 2) AccountDaoJdbc.transfer ( ... ); it throws InsufficientFundException.
 * 
 */
public class Sample4d {
	...
	public static void main(String[] args) {
		...
		try
		{
			ApplicationContext beanFactory = new FileSystemXmlApplicationContext ( "/src/transaction/progmatically/sample.xml" );
			...
			Customer customer4 = new Customer ( 4, "Peter", "Pan", "(416)123-1230", "10 Sheppard Ave E", "smithj@yahoo.ca" );
			Customer customer5 = new Customer ( 5, "Bright", "Wang", "(416)123-1231", "11 Sheppard Ave E", "sunm@rogers.ca" );
			Customer customer6 = new Customer ( 6, "Paul1", "Lun", "(416)123-1232", "12 Sheppard Ave E", "paul.martin@gov.ca" );
			...
			// The following codes are designed to demo the account records insertion.
...
//			System.out.println ( acct2 );
			...
			accountService.transfer ( acct, acct2, 999 );
			System.out.println ( acct );
			System.out.println ( acct2 );
